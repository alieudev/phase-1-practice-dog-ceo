...
//     console.log(img)
//     imgDiv.append(img)
//     document.querySelector('#dog-image-container').append(imgDiv)
// }

// function renderBreeds(breed) {
//     let ul = document.createElement('ul')
//     ul.textContent = bread
//     document.querySelector('#dog-breeds').append(ul)
// }
...
//     fetch(breedUrl)
//     .then(res => res.json())
//     .then(breed => Object.keys(breed.message).forEach(renderBreeds))
// }